...
userSchema.pre("save", async function (next) {
  // this is middleware or basically handling save before the actual save to the database
  try {
    const user = this;
...
userSchema.methods.comparePassword = function (password) {
  // use in login to compare user input password to the hashed password
  try {
    const user = this;
